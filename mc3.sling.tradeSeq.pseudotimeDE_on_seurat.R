...
cds_monocle3=readRDS(paste0("/home/dcha/02.glioblastoma_scRNAseq/rdata/monocle3_data/mc3_",gsub("_seurat", "",fn)))
...
saveRDS(resList, paste0(path,"seurat.mc3.slingTradePT.pc",npcs,".nk",nknots,".",glm_type,".sample",subsampleNum,".",fn))
