...
workdir="/home/jsh/01.Project/Celltype/20220622/08.mt2_PU1/"
...
## Venn Diagram / UpSet plot (raw VCFs for cell types)
```{r}
require(ggvenn)
...
### Evolution of shared mutations onto the MP tree
```{r}

require(treeio); require(ggtree)
...
### Mutational signature analyses (VCF prep)
```{r}
...
### Mutational catalogs for each cell type
```{r}
...
### Mutational signatures re-fitting on COSMIC SBS Sig
```{r}
...
### Mutational signatures de novo decomposition of cell types
```{r}
require(NMF)
